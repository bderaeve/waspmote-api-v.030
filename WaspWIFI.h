...
class WaspWIFI
{
  ...
  private:	
    ...
    */
    boolean contains(char* text, char* word);
  ...
  public:
    ...
    */ 
    ...
    //! Opens the UART.
    /*!
      Selects the pins and the baud rate of the waspmote.
      \param void
      \return void
    */ 
    void begin();
    ...
    */
    ...
    /*!
      ...
      auto-join.
      \param boolean passive : Enables or disables the pasive scan.
      \return '1' on success, '0' otherwise.
    */
    uint8_t setScanOptions(uint16_t time, char* mask, boolean passive);
